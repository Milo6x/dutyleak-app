          ...
          <div className="bg-gray-50 rounded-xl p-8">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-1">Database</div>
                  <div className="text-sm text-gray-900">{health.database}</div>
                </div>
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-1">Version</div>
                  <div className="text-sm text-gray-900">{health.version}</div>
                </div>
                <div>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gradient-to-r from-blue-500 to-blue-600 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="text-center text-white">
              <ChartBarIcon className="mx-auto h-24 w-24 mb-4" />
              <h3 className="text-2xl font-bold">Smart Analytics</h3>
              <p className="mt-2 text-blue-100">AI-powered duty optimization</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Import and manage your product catalog with detailed specifications, dimensions, and classifications.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">HS Code Classification</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  AI-powered HS code suggestions with confidence scoring and expert review workflows.
                </dd>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Duty Optimization</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Automatically find the lowest duty rates and calculate potential savings across your entire catalog.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Comprehensive dashboards and reports to track savings, compliance, and optimization opportunities.
                </dd>
              </div>
            </dl>
          </div>
